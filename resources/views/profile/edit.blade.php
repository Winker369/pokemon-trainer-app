                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update', $user) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="birthday" type="date" class="form-control @error('birthday') is-invalid @enderror" name="birthday" value="{{ old('birthday', $user->birthday) }}" autocomplete="birthday" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="gender" class="form-control @error('gender') is-invalid @enderror" aria-label=".form-select-lg example" name="gender" value="{{ old('gender', $user->gender) }}" autocomplete="gender" autofocus>
                                    <option>Are you a boy? Or are you a girl?</option>
                                    @foreach (App\Enums\Gender::values() as $value)
                                    <option value="{{ $value }}" <?= $value == $user->gender ? ' selected' : '' ?>>{{ $value }}</option>
                                    @endforeach
                                </select>
